...
def test_negative_numbers():
    ...
    assert insertion_sort([0, -1, 4, -3, 2]) == [-3, -1, 0, 2, 4]
...
def test_nearly_sorted():
    # Nearly sorted data triggers O(n) performance with minimal shifts
    # [1,2,3,4,6,5] has one element out of place
    assert insertion_sort([1, 2, 3, 4, 6, 5]) == [1, 2, 3, 4, 5, 6]
